...
terraform {
  source = "git::https://github.com/meshcloud/meshstack-hub.git//modules/aks/starterkit?ref=061eef51316b2add66e11062449d19871a6ba618"
}
...
inputs = {
  ...
  hub = { git_ref = "061eef51316b2add66e11062449d19871a6ba618", bbd_draft = true }
