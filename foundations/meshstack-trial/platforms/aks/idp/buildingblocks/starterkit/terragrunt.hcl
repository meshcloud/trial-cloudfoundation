...
terraform {
  source = "git::https://github.com/meshcloud/meshstack-hub.git//modules/aks/starterkit?ref=b7ac0aa9818db730958f64e7ba0fdeecedcfbd4e"
}
...
inputs = {
  ...
  hub = { git_ref = "b7ac0aa9818db730958f64e7ba0fdeecedcfbd4e", bbd_draft = false }
